 ...
 * @author toalgrim
 */
public class ListaUtentiGui extends JFrame{
    ...
    public ListaUtentiGui(Connection db, ArrayList listaUtenti) {
        this.db = db;
        initComponents(listaUtenti);
        this.setVisible(true);
    }
    
    private void initComponents(ArrayList listaUtenti) {
        ...
        for (int i=0; i<listaUtenti.size(); i++) {
            model.addElement(listaUtenti.get(i));
        }
        
        jElimina.setFont(new java.awt.Font("Dialog", 1, 30)); // NOI18N
        jElimina.setText("Elimina utente");
